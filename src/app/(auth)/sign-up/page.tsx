...
function Page() {
    ...
    const onSubmit = async (formData: z.infer<typeof signUpSchema>) => {
        ...
        try {
            const { data } = await axios.post<IApiResponse>('api/sign-up',
                ...
                <div className='w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md'>
                    ...
                    <Form  {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        {isCheckingUserName && <Loader2 className='mt-4 w-6 h-6 ml-10 animate-spin' />}
                                        <p className="text-center text-sm tracking-tight text-stone-600 mt-2">{usernameMessage}</p>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                            ...
                            />
                            <Button type='submit' variant="outline">{isSubmitting ? <>
